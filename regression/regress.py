...
if fname_dataset_validation is not None:
    ...
    features_validation = dataset_validation[:, 1:] - dataset_validation[i_wt_validation, 1:]
    metrics_validation = dataset_validation[:, 0] - dataset_validation[i_wt_validation, 0]
...
for train_index, test_index in kf.split(features):
    ...
    if fname_dataset_validation is not None:
        metrics_validation_predict = scaler_metrics.inverse_transform(model.predict(scaler_features.transform(features_validation)))
